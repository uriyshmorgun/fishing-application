...
function ChartUsers(Component) {
   return class extends React.Component {
      ...
      render() {
         ...
         const { props } = this
         return (
            <div style={{ width: 500, height: 500 }} ref={node => (this.node = node)}>
               {width && <Component width={width} height={height} {...props} />}
            </div>
         )
      }
   }
...
export default ChartUsers(BarChart)
